...
/**
 * THIS IS JUST A CRAZY HACK TO HANDLE MESS IN MIDPOINT LOGGING LIBRARIES
 * MidPoint {@link com.evolveum.midpoint.util.logging.LoggingUtils} and
 * other classes are directly referencing {@link ch.qos.logback.classic.Level}
 * which is wrong on multiple levels, mainly because we're using Slf4J as
 * logging API. Logback classes should be hidden and not linked as compile
 * dependencies for MidPoint infra libraries. Instead {@link org.slf4j.event.Level}
 * should be used.
 */
