...
public class ShowSchemaConnectorStep extends ConnectorGeneratorWizardStep {
    public ShowSchemaConnectorStep(ConnectorGeneratorBasicWizard wizardContext, StepStateBadge.State step) {
