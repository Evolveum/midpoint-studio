...
public class ObjectClassSelectConnectorStep extends ConnectorGeneratorWizardStep {
    public ObjectClassSelectConnectorStep(ConnectorGeneratorBasicWizard wizardContext, StepStateBadge.State step) {
