...
public class ActionsEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    private void apply() throws SchemaException {
        PsiFile resourcePsiFile = MidPointUtils.findPsiByOid(project, value.getResource().getOid());
        ResourceType resource = prismContext.parserFor(resourcePsiFile.getText()).parseRealValue(ResourceType.class);
