...
public class TestConnectionPanel extends JBPanel<TestConnectionPanel> implements WizardContent {

    public TestConnectionPanel(ConnectorGeneratorDataModel context) {
