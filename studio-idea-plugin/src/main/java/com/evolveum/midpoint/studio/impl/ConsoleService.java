...
public class ConsoleService {
    ...
    public static ConsoleService get(@NotNull Project project) {
        return project.getService(ConsoleService.class);
    }
    ...
    public void focusConsole() {
        ToolWindow tw = ToolWindowManager.getInstance(project).getToolWindow(MidPointToolWindowFactory.WINDOW_ID);
        if (tw == null) {
