 ...
 */
public class SPropertiesPathItem extends CompositePsiElement {

    public SPropertiesPathItem() {
        super(SPropertiesTokenTypes.RULE_ELEMENT_TYPES.get(StudioPropertiesParser.RULE_pathItem));
    }
