...
public class ResourceTestConnectorStep extends ConnectorGeneratorWizardStep {
    public ResourceTestConnectorStep(ConnectorGeneratorBasicWizard wizardContext, StepStateBadge.State step) {
