...
public class ConnectionConnectorStep extends ConnectorGeneratorWizardStep {


    public ConnectionConnectorStep(ConnectorGeneratorBasicWizard wizardContext, StepStateBadge.State step) {
