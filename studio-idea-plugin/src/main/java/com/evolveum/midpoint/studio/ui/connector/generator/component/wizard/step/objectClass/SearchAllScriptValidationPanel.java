...
public class SearchAllScriptValidationPanel extends JBPanel<SearchAllScriptValidationPanel> implements WizardContent {

    public SearchAllScriptValidationPanel(ConnectorGeneratorDataModel context) {
