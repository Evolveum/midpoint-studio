...
import com.evolveum.midpoint.studio.ui.connector.generator.step.connection.AuthScriptsConnector;
import com.intellij.ide.wizard.CommitStepException;

import javax.swing.*;
import java.awt.*;

public class ObjectClassStep extends ConnectorGeneratorGeneralWizardStep {

    private AuthScriptsConnector authScriptsConnector;
    private final JPanel mainPanel = new JPanel(new BorderLayout());

    public ObjectClassStep(
        ...
        mainPanel.setName("Object Class");
    }
