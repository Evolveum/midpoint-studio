...
public class SchemaValidationPanel extends JBPanel<SchemaValidationPanel> implements WizardContent {

    public SchemaValidationPanel(ConnectorGeneratorDataModel context) {
