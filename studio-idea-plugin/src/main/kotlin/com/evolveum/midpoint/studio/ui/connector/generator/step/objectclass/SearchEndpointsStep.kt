...
//
//        row {
//            cell(JBLabel("Select List Objects Endpoints").apply {
...
//        row {
//            text("""
//            Select endpoint to be used in search operation. The assistant may suggest default search endpoints or parameters based on available documentation. If no suggestion fits, you can specify a custom search endpoint manually.
//            """.trimIndent())
//                .align(AlignX.FILL)
