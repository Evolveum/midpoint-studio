...
// Added catch-all INVALID_CHAR rule to report invalid characters as
// errors instead of silently skipping them, specifically for intellij idea plugin
...
// added to catch invalid characters and report them as errors instead of silently skipping them
// specifically for intellij idea plugin
INVALID_CHAR : . ;