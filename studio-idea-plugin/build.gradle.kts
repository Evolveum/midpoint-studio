...
//
//    // Plugin Dependencies. Uses `platformPlugins` property from the gradle.properties file.
//    plugins.set(listOf(*properties("platformPlugins").split(',').map(String::trim).filter(String::isNotEmpty).toTypedArray()))
//}
//
//// Configure gradle-changelog-plugin plugin.
//// Read more: https://github.com/JetBrains/gradle-changelog-plugin
...
//
//    runPluginVerifier {
//        ideVersions.addAll(properties("pluginVerifierIdeVersions").split(',').map(String::trim).filter(String::isNotEmpty).toList())
//    }
//
//    publishPlugin {
//        dependsOn("patchChangelog")
...
//////        ideVersions = ["IC-2020.3.2", "IC-2021.1.1"]
//////    }
////    publishPlugin {
