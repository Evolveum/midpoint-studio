...
public class MidPointObject {
    ...
    /**
     * used to derive output file names (and to delete files)
     */
    private File file;

    /**
     * object number in the resource (if applicable)
     */
    private int objectIndex;

    /**
     * how to identify object in messages, logs, etc.
     */
    private String displayName;

    /**
     * is this a root element in the file?
     */
    private boolean root;

    /**
     * is this a last one in the file?
     */
